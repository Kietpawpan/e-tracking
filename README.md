...
## วัตถุประสงค์
เพื่อเพิ่มประสิมธิภาพการแจ้งสถานะคำขอข้อมูลข่าวสารของ สป.ทส. ผ่านระบบดิจิทัล
...
1. ศึกษาภาษาอังกฤษ 
   - เรียนคำศัพท์พื้นฐาน 10,000 คำ จากพจนานุกรมอัวกฤษ-อังกฤษ (Oxford Advanced Learner's Dictionary)
   - เรียนอังกฤษไวยากรณ์ จาก Oxford Grammar
   - เรียนการใช้คำจาก Oxford Usage
   - เรียนสไตล์การเขียนจาก The Element of Style
2. ศึกษากฎหมายที่เกี่ยวข้อง
   - พ.ร.บ. ข้อมูลข่าวสารของราชการ พ.ศ. 2540 (__ผ่านการทดสอบของ สปน.__)
   - พ.ร.บ. บริหารงานภาครัฐและบริการประชาชนผ่านระบบดิจิทัล พ.ศ. 2562
   - พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (__ผ่านการทดสอบของคณะนิติศาสตร์ จุฬาลงกรณ์มหาวิทยาลัย__)
   - พ.ร.บ. การปฏิบัติราชการทางอิเล็กทรอนิกส์ พ.ศ. 2565
3. ศึกษาการพัฒนาบริการดิจิทัล
   - หลักสูตร Service Design ของ TDGA
...
4. ขออนุมัติใช้บริการระบบคลาวด์กลางภาครัฐ
5. สร้างเครื่องแม่ข่ายบนคลาวด์ (Elastic Cloud Server) ผ่านโปรแกรม OpenStack
6. ลงระบบปฏิบัติการ Windows 2019
7. ลงโปรแกรม Antivirus
8.  ขออนุมัติกำหนดชื่อโดเมนย่อย esc.mnre.go.th สำหรับเครื่องแม่ข่ายตามข้อ 2
9.  ออนุญาตใช้ใบรับรองความปลอดภัย SSL Certificate ที่ดูแลโดยศูนย์เทคโนโลยีดิจิทัลและอากาศยาน สป.ทส.
10. สร้าง Web Server โดยติดตั้งโปรแกรม Apache เวอร์ชันล่าสุด พร้อมตั่งค่าต่าง ๆ เพื่อความปลอดภัยไซเบอร์
11. ตั้งโปรแกรม PHP บน Apache
12. ติดตั้ง SSL Certificate สำหรับโดเมนย่อย *.mnre.go.th บน Apache
13. ทบทวน source code ของโปรแกรม e-Tracking ที่เชื่อมต่อกับระบบ e-Request
14. ออกแบบระบบดิจิทัล เพื่อรองรับการบริหารจัดการฐานข้อมูลและการบริการแจ้งสถานะคำขอผ่านระบบดิจิทัล ดังนี้
...
10. ซักซ้อมแนวทางปฏิบัติและเปิดใช้งาน ให้บริการแก่ประชาชนทุกรายที่ยื่นคำขอข้อมูลข่าวสารของ สป.ทส. ตั้งแต่ไตรมาสที่ 3 ปีงบประมาณ พ.ศ. 2568

## งบประมาณ
ค่าจัดซื้อใบรับรองความปลอดภัย Secure Socket Layer (SSL) อายุ 1 ปี วงเงิน 5,000 บาท (กรณี สป.ทส. ไม่มีใบรับรองสำหรับโดเมนย่อย)
> [!NOTE]
> ไม่ต้องมีค่าใช้จ่ายสำหรับจัดจ้างที่ปรึกษาหรือโปรมแกรมเมอร์ เนื่องจากมีเจ้าหน้าที่เป็นนักพัฒนาโปรแกรม ประเภท Full Stack Developer 
