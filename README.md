...
4. ขออนุมัติกำหนดชื่อโดเมนย่อย esc.mnre.go.th สำหรับเครื่องแม่ข่ายตามข้อ 2
5. ขออนุญาตใช้ใบรับรองความปลอดภัย SSL Certificate ที่ดูแลโดยศูนย์เทคโนโลยีดิจิทัลและอากาศยาน สป.ทส.
6. สร้าง Web Server โดยติดตั้งโปรแกรม Apache เวอร์ชันล่าสุด พร้อมตั่งค่าต่าง ๆ เพื่อความปลอดภัยไซเบอร์
7. ติดตั้งโปรแกรม PHP บน Apache
8. ติดตั้ง SSL Certificate บน Apache
9. ทบทวน source code ของโปรแกรม e-Tracking ที่เชื่อมต่อกับระบบ e-Request
10. ออกแบบระบบดิจิทัล เพื่อรองรับการบริหารจัดการฐานข้อมูลและการบริการแจ้งสถานะคำขอผ่านระบบดิจิทัล ดังนี้
```mermaid
sequenceDiagram
